...
public class MainScenePopupController : MonoBehaviour
{
    ...
    private void EnsureAchievementPopupBinding()
    {
        if (popupAchievement == null)
        {
            return;
        }

        if (popupAchievement.GetComponent<AchievementPopupUI>() == null)
        {
            popupAchievement.AddComponent<AchievementPopupUI>();
        }
    }
